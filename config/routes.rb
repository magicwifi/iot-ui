...
get "/:deviceid/:sensor/:date/show_speed" => "limoes#show_speed",  :as => "limoes_show_speed"
get "/:deviceid/:sensor/:date/show_speed_topvalue" => "limoes#show_speed_topvalue",  :as => "limoes_show_speed_topvalue"
get "/:deviceid/:sensor/:date/show_speed_24h" => "limoes#show_speed_24h",  :as => "limoes_show_speed_24h"
